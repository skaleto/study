...
public class WebIATWS extends WebSocketListener {
    private static final String hostUrl = "http://172.31.131.18:26100/api/iat/v1/task"; //中英文，http url 不支持解析 ws/wss schema
    // private static final String hostUrl = "https://iat-niche-api.xfyun.cn/v2/iat";//小语种
    private static final String apiKey = "mykey"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "692A47C7F854447DB3198DD444057C56"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5e79c99f"; //在控制台-我的应用获取
    private static final String file = "/Users/yaoyibin/iflytest/tts/20200421164731504.pcm"; // 中文
