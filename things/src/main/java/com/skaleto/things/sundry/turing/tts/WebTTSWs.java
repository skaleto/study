...
public class WebTTSWs {
    ...
    private static final String apiSecret = "26540e96de8a6c55c7a2f9c4c510eb4f";//到控制台-语音合成页面获取
    private static final String apiKey = "4f5bcce6390e74faff0f92ec6a643a09";//到控制台-语音合成页面获取
    private static final String text = "检测到烟雾";
    ...
    public static void main(String[] args) throws Exception {
        ...
        File f = new File("/Users/yaoyibin/Downloads/test/" + date + ".pcm");
        if (!f.exists()) {
            f.createNewFile();
        }
