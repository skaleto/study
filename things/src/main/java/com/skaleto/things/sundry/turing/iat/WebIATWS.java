...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String apiKey = "4f5bcce6390e74faff0f92ec6a643a09"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "26540e96de8a6c55c7a2f9c4c510eb4f"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5e79c99f"; //在控制台-我的应用获取
    private static final String file = "/Users/yaoyibin/test0820.wav"; // 中文
