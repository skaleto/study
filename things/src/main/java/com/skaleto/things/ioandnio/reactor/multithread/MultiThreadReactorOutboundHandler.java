...
@Slf4j
public class MultiThreadReactorOutboundHandler implements EventHandler {

    SocketChannel socketChannel;
    Selector selector;

    public MultiThreadReactorOutboundHandler(SocketChannel socketChannel, Selector selector) {
